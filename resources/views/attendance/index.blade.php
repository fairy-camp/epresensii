...
<div class="container-fluid">
    ...
    <div class="card card-outline card-primary mb-3 shadow-sm">
        <div class="card-header bg-white">
            <h5 class="card-title mb-0 fw-bold">
                <i class="fas fa-calendar-alt me-2 text-primary"></i> Pilih Tanggal Presensi
            </h5>
        </div>
        <div class="card-body">
            <form method="GET" action="{{ route('attendances.index') }}" class="row g-3 align-items-end">
                ...
                <div class="col-md-3 col-sm-6">
                    <a href="{{ route('attendances.index') }}" class="btn btn-secondary w-100">
                        <i class="fas fa-sync-alt me-1"></i> Hari Ini
                    </a>
                </div>
            </form>
        </div>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white">
            <h5 class="card-title mb-0 fw-bold">
                <i class="fas fa-clipboard-list me-2 text-primary"></i>Daftar Kehadiran Tanggal: <strong>{{ \Carbon\Carbon::parse($date)->translatedFormat('d F Y') }}</strong>
            </h5>
        </div>
            ...
            <div class="table-responsive">
                <table id="attendancesTable" class="table table-hover align-middle mb-0 w-100">
                    ...
                    <tbody>
                        ...
                        @empty
                            {{-- DataTables akan menangani tampilan kosong --}}
                        @endforelse
                    </tbody>
                </table>
            </div>
